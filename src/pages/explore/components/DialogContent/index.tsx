...
import { UserFormRating } from './components/UserFormRating'
...
export function DialogContent({ selectedBookId }: DialogContentProps) {
  return (
    <Dialog.Portal>
      ...
      <div className="fixed top-0 right-0 bottom-0 max-w-[660px] w-full bg-gray-800">
        <div className="py-16 px-12 flex flex-col gap-10">
      ...
      <Dialog.Close>
        <X
          size={24}
          weight="bold"
          className="absolute top-6 right-12 text-gray-400"
        />
      </Dialog.Close>
    </Dialog.Portal>
  )
